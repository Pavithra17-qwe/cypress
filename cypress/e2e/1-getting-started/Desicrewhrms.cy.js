describe('Login Test', () => {
    ...
    it('should navigate to profile page', () => {
        ...
        cy.get("#AssociateName").should('have.text',' Pavithra A')
        cy.get("a[data-toggle='tab'][href='#tabbankdetails']").should('contain','Bank Details')
        cy.get("div[data-field-key='Field_BankName'] div[class='field-value']").should('contain','HDFC Bank')
    ...
    cy.wait(2000)
        // Check if "No data available in the table" is visible
